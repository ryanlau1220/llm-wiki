...
import {
  ...
  listAiTracesSchema,
  getAiTraceSchema,
  recordAiTraceFeedbackSchema,
  aiTracePageSchema,
  aiTraceDetailSchema,
  aiTraceFeedbackSchema,
  ensureAiEvaluationBaselineSchema,
  addAiEvaluationRegressionCaseSchema,
...
export const appContract = oc.router({
  ...
  recordAiTraceFeedback: oc.input(recordAiTraceFeedbackSchema).output(aiTraceFeedbackSchema),
  ensureAiEvaluationBaseline: oc.input(ensureAiEvaluationBaselineSchema).output(aiEvaluationDatasetSchema),
  addAiEvaluationRegressionCase: oc.input(addAiEvaluationRegressionCaseSchema).output(aiEvaluationDatasetSchema),
