...
import {
  ...
  aiTracePageSchema,
  aiTraceDetailSchema,
  bootstrapAiEvaluationGoldenSuiteSchema,
  activateAiEvaluationGoldenSuiteSchema,
  discardAiEvaluationSilverCaseSchema,
  listAiEvaluationCasesSchema,
  ...
  aiEvaluationCaseSummarySchema,
  aiEvaluationRunSchema,
  aiEvaluationCapabilitiesSchema,
...
export const appContract = oc.router({
  ...
  listResearchRadarStarterSources: oc.input(z.void().optional()).output(z.array(researchRadarStarterSourceSchema)),
  installResearchRadarStarterPack: oc.input(installResearchRadarStarterPackSchema).output(z.object({
    added: z.array(researchSourceSchema),
    skipped: z.number().int().nonnegative(),
  ...
  bootstrapAiEvaluationGoldenSuite: oc.input(bootstrapAiEvaluationGoldenSuiteSchema).output(aiEvaluationDatasetSchema),
  activateAiEvaluationGoldenSuite: oc.input(activateAiEvaluationGoldenSuiteSchema).output(aiEvaluationDatasetSchema),
  discardAiEvaluationSilverCase: oc.input(discardAiEvaluationSilverCaseSchema).output(aiEvaluationDatasetSchema),
  listAiEvaluationDatasets: oc.input(z.void().optional()).output(z.array(aiEvaluationDatasetSchema)),
  listAiEvaluationCases: oc.input(listAiEvaluationCasesSchema).output(z.array(aiEvaluationCaseSummarySchema)),
  runAiEvaluation: oc.input(runAiEvaluationSchema).output(aiEvaluationRunSchema),
  getAiEvaluationCapabilities: oc.input(z.void().optional()).output(aiEvaluationCapabilitiesSchema),
