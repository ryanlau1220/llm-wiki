...
import {
  ...
  generateAiEvaluationCandidatesSchema,
  listAiEvaluationCasesSchema,
  promoteAiEvaluationCaseSchema,
...
export const appContract = oc.router({
  ...
  generateAiEvaluationCandidates: oc.input(generateAiEvaluationCandidatesSchema).output(aiEvaluationDatasetSchema),
  promoteAiEvaluationCase: oc.input(promoteAiEvaluationCaseSchema).output(z.object({
    datasetId: z.string().uuid(),
    lifecycle: z.literal("gold"),
  })),
