            ...
            {weakNotesQuery.data.map((note) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 bg-sea-ink text-bg-base rounded-xl font-bold text-sm hover:bg-lagoon-deep hover:text-bg-base transition-all disabled:opacity-50"
                >
                  {analyzingId === note.id ? (
                    <>
